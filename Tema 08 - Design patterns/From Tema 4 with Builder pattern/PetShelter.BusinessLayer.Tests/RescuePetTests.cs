...
using Moq;
using PetShelter.BusinessLayer.Builders;
...
namespace PetShelter.BusinessLayer.Tests
{
    public class RescuePetTests
    {
        ...
        private void SetupHappyPath()
        {
            ...
            BuilderRescuePet builder = new BuilderRescuePet();
            DirectorRescuePet directorRescuePet = new(builder);

            _request = directorRescuePet.setDefaultCat();
        }
